...
if (isset($_POST["name"]) && isset($_FILES["fileUpload"]["name"])) {
    ...
    if ($uploadOk == 1) {
        ...
        $pro_image = $nameFile;
        $check = $productsModel->insertProduct($name, $manu, $type, $price, $pro_image, $desription, $feature);
        if ($check) {
                                    ...
                                    <div class="controls">
                                        <select name="manu_id" id="cate">
                                            <?php foreach ($manufactures as $manu) { ?>
                                                <option required value="<?php echo $manu['manu_id']; ?>"><?php echo $manu['manu_name']; ?> </option>
                                            <?php } ?>
                                        </select> *
                                    </div>
                                </div>
