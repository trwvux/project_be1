...
if(isset($_GET['manu_id'])){
    $manufacture = $ManuFacturesModel->getManuID($_GET['manu_id']);
}

if (isset($_POST['name'])) {
    $ManuFacturesModel->updateManu($_GET['manu_id'],$_POST['name']);
    header("Refresh:0;url=manufactures.php");
}
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input value="<?php echo $manufacture->manu_name; ?>" type="text" class="span11" placeholder="Product name" name="name" required /> *
                                    </div>
                                </div>
