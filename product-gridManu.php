...
// }
if (isset($_GET['manu'])) {
    $products = $productModel->getProductsManu($_GET['manu']);
    $manufacturesID = $manuFacturesModel->getAllManuFacturesFromID($_GET['manu']);
}
if (isset($_SESSION['username'])) {
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                    ...
                                    <span class="breadcrumb-item active">Hãng Sản Xuất</span>
                                    <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                                    <span class="breadcrumb-item active">
                                        <?php foreach ($manufacturesID as $manufacture) { ?>
                                            <a href="product-gridManu.php?manu=<?php echo $manufacture['manu_id'] ?>"><?php echo $manufacture['manu_name'] ?></a>
                                        <?php } ?>
                                    </span>
                                </nav>
                            </div>
                        ...
                        <div class="htc__product__rightidebar">
                            <div class="htc__grid__top">
                                <div class="ht__pro__qun">
                                    <span>Hiển thị <?php echo count($products); ?> sản phẩm</span>
                                </div>
                    ...
                    <div class="col-lg-3 col-lg-pull-9 col-md-3 col-md-pull-9 col-sm-12 col-xs-12 smt-40 xmt-40">
                        <div class="htc__product__leftsidebar">
                            ...
                            <div class="htc__category">
                                <h4 class="title__line--4">Hãng </h4>
                                <ul class="ht__cat__list">
                                    <?php foreach ($manufactures as $manufacture) { ?>
                                        <li class="drop"><a href="product-gridManu.php?manu=<?php echo $manufacture['manu_id'] ?>"><?php echo $manufacture['manu_name'] ?></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                            <!-- End Category Area -->
